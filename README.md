...
This probes a random sample of 100 examples from `eval_clean.jsonl` by default and reports aggregate clean, canary-inserted, and not-found behavior. Use `--sample_size` and `--sample_seed` to override that sampling.
